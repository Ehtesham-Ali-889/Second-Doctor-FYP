...
import Bank from '../assets/deposit.png'
...
const AccountCard = ({user,updateUsers}) => {
  ...
  const deleteUserData = async (id) => {
    axios
      .delete('http://localhost:3010/account/removeAccount/' + id)
      .then((res) => {
    ...
    const response = await axios.get(
      "http://localhost:3010/account/allAccountslist"
    );
        ...
        <View style={{backgroundColor:'white',flexDirection:'row',padding:'25px'}}>
            ...
            <View  style={{flexDirection:'column',justifyContent:'center',alignItems:'center',marginLeft:'40px'}}>
                ...
                <View style={{flexDirection:'row'}}>
                    <Button onClick={() => navigation.navigate('EditAccount',{
                        id:user._id,
                        name:user.accname,
                    ...
                    <Dialog
                        ...
                        >
                            <DialogTitle>{"Delete Account Record"}</DialogTitle>
                            <DialogContent>
                            <DialogContentText id="alert-dialog-slide-description">
                                Do you confirm to delete Account record?
                            </DialogContentText>
                            </DialogContent>
                            <DialogActions>
