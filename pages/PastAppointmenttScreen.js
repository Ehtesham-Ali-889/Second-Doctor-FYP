...
import PastAppointmentList from '../pagination/PastAppointmentList';
...
const PastAppointmentScreen = () => {
  ...
  useEffect(()=>{
    const fetchData=()=>{
        fetch('http://localhost:3010/appointment/pastappointments')
  ...
  return (
    <View style={{ margin:'10px',marginLeft:'50px',marginRight:'50px' }}>
      ...
      <View style={{flexDirection:'row',justifyContent:'space-between'}}>
        <Text style={{fontSize:'40px',fontWeight:'bold',margin:'10px',marginLeft:'0px'}}>Past Appointments</Text>
      ...
      <PastAppointmentList users={currentPosts} updateUsers={setUsers} />
